...
const customers = [
  { id: "C-001", nama: "Budi Santoso", phone: "0812-3456-7890", kota: "Tegal", status: "Hot Lead", nilai: 22800000, sales: "Rina W.", tanggal: "24 Mar" },
  { id: "C-002", nama: "Siti Rahayu", phone: "0813-9876-5432", kota: "Slawi", status: "Negosiasi", nilai: 37500000, sales: "Dodi P.", tanggal: "23 Mar" },
  { id: "C-003", nama: "Ahmad Fauzi", phone: "0857-1122-3344", kota: "Brebes", status: "Closing", nilai: 17500000, sales: "Rina W.", tanggal: "22 Mar" },
  { id: "C-004", nama: "Dewi Lestari", phone: "0821-5566-7788", kota: "Tegal", status: "Prospek", nilai: 42000000, sales: "Hendra K.", tanggal: "22 Mar" },
  { id: "C-005", nama: "Rizky Pratama", phone: "0877-9900-1122", kota: "Bumiayu", status: "Hot Lead", nilai: 28500000, sales: "Dodi P.", tanggal: "21 Mar" },
  { id: "C-006", nama: "Nur Hidayah", phone: "0895-4433-2211", kota: "Tegal", status: "Closing", nilai: 23900000, sales: "Hendra K.", tanggal: "20 Mar" },
  { id: "C-007", nama: "Dian Wahyu", phone: "0811-2233-4455", kota: "Ketanggungan", status: "Prospek", nilai: 19500000, sales: "Rina W.", tanggal: "19 Mar" },
  { id: "C-008", nama: "Faris Aldrian", phone: "0856-7788-9900", kota: "Slawi", status: "Negosiasi", nilai: 38500000, sales: "Dodi P.", tanggal: "18 Mar" },
];

const serviceOrders = [
  { id: "SVC-0254", pelanggan: "Bambang S.", motor: "Honda BEAT 2023", plat: "G 4521 XB", keluhan: "Tune up + ganti oli", teknisi: "Eko S.", status: "Selesai", jam: "09:00", est: "10:30", cabang: "Tegal Kota" },
  { id: "SVC-0255", pelanggan: "Wulan P.", motor: "Honda VARIO 125 2022", plat: "G 7832 AB", keluhan: "Ganti kampas rem + cek karbu", teknisi: "Fajar R.", status: "Dikerjakan", jam: "09:30", est: "11:00", cabang: "Tegal Kota" },
  { id: "SVC-0256", pelanggan: "Harun N.", motor: "Honda PCX 160 2024", plat: "G 1234 YC", keluhan: "Service berkala 8.000 km", teknisi: "Eko S.", status: "Antri", jam: "10:00", est: "11:30", cabang: "Slawi" },
  { id: "SVC-0257", pelanggan: "Lina M.", motor: "Honda SCOOPY 2021", plat: "G 9988 SD", keluhan: "Mogok, aki lemah", teknisi: "Budi T.", status: "Antri", jam: "10:30", est: "12:00", cabang: "Slawi" },
  { id: "SVC-0258", pelanggan: "Tono A.", motor: "Honda CBR 150R 2023", plat: "G 5577 RF", keluhan: "Ganti rantai + sproket", teknisi: "Fajar R.", status: "Dikerjakan", jam: "11:00", est: "13:00", cabang: "Brebes" },
  { id: "SVC-0259", pelanggan: "Maya S.", motor: "Honda ADV 160 2024", plat: "G 3344 TG", keluhan: "Service berkala 4.000 km (KPB)", teknisi: "Budi T.", status: "Selesai", jam: "08:00", est: "09:30", cabang: "Tegal Kota" },
  { id: "SVC-0260", pelanggan: "Gilang R.", motor: "Honda GENIO 2022", plat: "G 6611 MN", keluhan: "Bunyi aneh di mesin", teknisi: "Eko S.", status: "Antri", jam: "13:00", est: "14:30", cabang: "Bumiayu" },
];

const employees = [
  { id: "EMP-001", nama: "Rudi Hartono", jabatan: "Branch Manager", dept: "Manajemen", cabang: "Tegal Kota", status: "Aktif", gaji: 8500000, join: "Jan 2019", av: "RH" },
  { id: "EMP-002", nama: "Rina Wulandari", jabatan: "Sales Executive", dept: "Sales", cabang: "Tegal Kota", status: "Aktif", gaji: 5200000, join: "Mar 2021", av: "RW" },
  { id: "EMP-003", nama: "Dodi Prasetyo", jabatan: "Sales Executive", dept: "Sales", cabang: "Slawi", status: "Aktif", gaji: 5000000, join: "Jun 2020", av: "DP" },
  { id: "EMP-004", nama: "Hendra Kusuma", jabatan: "Senior Sales", dept: "Sales", cabang: "Brebes", status: "Aktif", gaji: 6000000, join: "Feb 2018", av: "HK" },
  { id: "EMP-005", nama: "Eko Santoso", jabatan: "Kepala Mekanik", dept: "Workshop", cabang: "Tegal Kota", status: "Aktif", gaji: 7000000, join: "Sep 2017", av: "ES" },
  { id: "EMP-006", nama: "Fajar Ramadan", jabatan: "Mekanik Senior", dept: "Workshop", cabang: "Tegal Kota", status: "Aktif", gaji: 5500000, join: "Jul 2019", av: "FR" },
  { id: "EMP-007", nama: "Budi Trianto", jabatan: "Mekanik", dept: "Workshop", cabang: "Slawi", status: "Aktif", gaji: 4500000, join: "Nov 2021", av: "BT" },
  { id: "EMP-008", nama: "Sari Dewi", jabatan: "Admin & CS", dept: "Administrasi", cabang: "Tegal Kota", status: "Aktif", gaji: 4000000, join: "Apr 2022", av: "SD" },
  { id: "EMP-009", nama: "Agus Mulyono", jabatan: "Finance Staff", dept: "Keuangan", cabang: "Tegal Kota", status: "Aktif", gaji: 5500000, join: "Jan 2020", av: "AM" },
  { id: "EMP-010", nama: "Yanti Pratiwi", jabatan: "HR Officer", dept: "HR", cabang: "Tegal Kota", status: "Aktif", gaji: 5000000, join: "Aug 2021", av: "YP" },
  { id: "EMP-011", nama: "Rizal Hidayat", jabatan: "Warehouse Staff", dept: "Logistik", cabang: "Brebes", status: "Cuti", gaji: 3800000, join: "Feb 2023", av: "RH" },
  { id: "EMP-012", nama: "Nurul Aini", jabatan: "Sales Executive", dept: "Sales", cabang: "Bumiayu", status: "Aktif", gaji: 4800000, join: "Oct 2022", av: "NA" },
];
      ...
      <SectionCard
        ...
        action={
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <Btn><Plus size={13} /> Tambah Unit</Btn>
          </div>
        }
      >
            ...
            <tbody>
              {filtered.map((item, i) => (
                <tr key={item.id} style={{ borderTop: `1px solid ${C.border}`, background: i % 2 === 0 ? C.card : "#F8FAFC" }}>
                  ...
                  <td style={{ padding: "11px 16px" }}>
                    <button style={{ background: C.blueL, border: "none", borderRadius: 6, padding: "4px 10px", cursor: "pointer", color: C.blue, fontSize: 11, fontWeight: 600 }}>Edit</button>
                  </td>
                </tr>
              ))}
            </tbody>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {tab === "kanban" ? (
        ...
        <SectionCard
          ...
          action={<Btn><Plus size={13} /> Tambah Prospek</Btn>}
        >
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
            <thead>
              <tr style={{ background: C.bg }}>
            ...
            <tbody>
              {customers.map((c, i) => (
                <tr key={c.id} style={{ borderTop: `1px solid ${C.border}`, background: i % 2 === 0 ? C.card : "#F8FAFC" }}>
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <button style={{ background: C.blueL, border: "none", borderRadius: 6, padding: "4px 10px", cursor: "pointer", color: C.blue, fontSize: 11, fontWeight: 600 }}>Detail</button>
                  </td>
                </tr>
              ))}
            </tbody>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 16 }}>
        <SectionCard
          ...
          action={<Btn><Plus size={13} /> Order Baru</Btn>}
        >
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
              <thead>
...
function Finance() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <SectionCard title="Ringkasan Bulanan" subtitle="6 Bulan Terakhir" action={<Btn variant="outline"><Download size={13} /> Export</Btn>}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead>
            <tr style={{ background: C.bg }}>
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'DM Sans', sans-serif", background: C.bg, overflow: "hidden" }}>
      ...
      <div style={{ width: collapsed ? 68 : 224, background: C.navy, flexShrink: 0, display: "flex", flexDirection: "column", transition: "width 0.2s ease", overflow: "hidden" }}>
        ...
        <div style={{ padding: "18px 14px", borderBottom: "1px solid rgba(255,255,255,0.07)", display: "flex", alignItems: "center", gap: 11, height: 64, boxSizing: "border-box" }}>
          <div style={{ width: 36, height: 36, background: C.red, borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
